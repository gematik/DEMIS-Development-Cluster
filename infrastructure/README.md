...
| <a name="input_loki_s3_access_key_id"></a> [loki\_s3\_access\_key\_id](#input\_loki\_s3\_access\_key\_id) | The S3 access key id used by Loki when service\_mesh\_loki\_storage\_type is "s3".<br/>Leave empty to rely on an IAM role / instance profile (workload identity). | `string` | `""` | no |
| <a name="input_loki_s3_secret_access_key"></a> [loki\_s3\_secret\_access\_key](#input\_loki\_s3\_secret\_access\_key) | The S3 secret access key used by Loki when service\_mesh\_loki\_storage\_type is "s3".<br/>Leave empty to rely on an IAM role / instance profile (workload identity). | `string` | `""` | no |
...
| <a name="input_service_mesh_loki_backend_replicas"></a> [service\_mesh\_loki\_backend\_replicas](#input\_service\_mesh\_loki\_backend\_replicas) | Replica count for the SimpleScalable backend target. Defaults to service\_mesh\_loki\_replicas when not set. | `number` | `null` | no |
| <a name="input_service_mesh_loki_deployment_mode"></a> [service\_mesh\_loki\_deployment\_mode](#input\_service\_mesh\_loki\_deployment\_mode) | Loki deployment topology. Options: "Monolithic" (single-binary, default) or "SimpleScalable" (read/write/backend behind a gateway, requires "s3" storage). | `string` | `"Monolithic"` | no |
| <a name="input_service_mesh_loki_enabled"></a> [service\_mesh\_loki\_enabled](#input\_service\_mesh\_loki\_enabled) | Activates/Deactivates the deployment of Loki. Loki is only deployed if Monitoring (Grafana) is also enabled. | `bool` | `false` | no |
| <a name="input_service_mesh_loki_read_replicas"></a> [service\_mesh\_loki\_read\_replicas](#input\_service\_mesh\_loki\_read\_replicas) | Replica count for the SimpleScalable read target. Defaults to service\_mesh\_loki\_replicas when not set. | `number` | `null` | no |
| <a name="input_service_mesh_loki_replicas"></a> [service\_mesh\_loki\_replicas](#input\_service\_mesh\_loki\_replicas) | Number of Loki instances. Must be 1 for filesystem storage; values > 1 require S3 storage. In SimpleScalable mode this is the default for the read/write/backend targets unless overridden. | `number` | `1` | no |
| <a name="input_service_mesh_loki_retention_period"></a> [service\_mesh\_loki\_retention\_period](#input\_service\_mesh\_loki\_retention\_period) | How long ingested logs are kept before deletion (Go duration, e.g. 168h). | `string` | `"168h"` | no |
| <a name="input_service_mesh_loki_s3_bucket_admin"></a> [service\_mesh\_loki\_s3\_bucket\_admin](#input\_service\_mesh\_loki\_s3\_bucket\_admin) | S3 bucket for Loki admin/compactor objects. | `string` | `""` | no |
| <a name="input_service_mesh_loki_s3_bucket_chunks"></a> [service\_mesh\_loki\_s3\_bucket\_chunks](#input\_service\_mesh\_loki\_s3\_bucket\_chunks) | S3 bucket for Loki chunks. | `string` | `""` | no |
| <a name="input_service_mesh_loki_s3_bucket_ruler"></a> [service\_mesh\_loki\_s3\_bucket\_ruler](#input\_service\_mesh\_loki\_s3\_bucket\_ruler) | S3 bucket for Loki ruler rules. | `string` | `""` | no |
| <a name="input_service_mesh_loki_s3_endpoint"></a> [service\_mesh\_loki\_s3\_endpoint](#input\_service\_mesh\_loki\_s3\_endpoint) | S3 endpoint host used when service\_mesh\_loki\_storage\_type is "s3". | `string` | `""` | no |
| <a name="input_service_mesh_loki_s3_force_path_style"></a> [service\_mesh\_loki\_s3\_force\_path\_style](#input\_service\_mesh\_loki\_s3\_force\_path\_style) | Use path-style S3 URLs (true for MinIO / non-AWS, false for real AWS S3). | `bool` | `true` | no |
| <a name="input_service_mesh_loki_s3_insecure"></a> [service\_mesh\_loki\_s3\_insecure](#input\_service\_mesh\_loki\_s3\_insecure) | Talk to the S3 endpoint over plain HTTP instead of HTTPS. | `bool` | `false` | no |
| <a name="input_service_mesh_loki_s3_region"></a> [service\_mesh\_loki\_s3\_region](#input\_service\_mesh\_loki\_s3\_region) | S3 region used when service\_mesh\_loki\_storage\_type is "s3" (may be empty for MinIO / non-AWS). | `string` | `""` | no |
| <a name="input_service_mesh_loki_storage_type"></a> [service\_mesh\_loki\_storage\_type](#input\_service\_mesh\_loki\_storage\_type) | Storage backend for Loki. Options: "filesystem" (local disk, default) or "s3" (external S3-compatible object storage). | `string` | `"filesystem"` | no |
| <a name="input_service_mesh_loki_version"></a> [service\_mesh\_loki\_version](#input\_service\_mesh\_loki\_version) | The version of the Loki Helm Chart to be installed. | `string` | `""` | no |
| <a name="input_service_mesh_loki_write_replicas"></a> [service\_mesh\_loki\_write\_replicas](#input\_service\_mesh\_loki\_write\_replicas) | Replica count for the SimpleScalable write target. Defaults to service\_mesh\_loki\_replicas when not set. | `number` | `null` | no |
