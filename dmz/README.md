...
| [kubernetes_secret_v1.rabbit_mq_credentials](https://registry.terraform.io/providers/hashicorp/kubernetes/3.0.1/docs/resources/secret_v1) | resource |
...
| <a name="input_secure_message_gateway_url"></a> [secure\_message\_gateway\_url](#input\_secure\_message\_gateway\_url) | URL of the Secure Message Gateway | `string` | `"https://secure-message-gateway.dmz.svc.cluster.local:8080"` | no |
